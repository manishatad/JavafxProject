...
void c2w_newBrowserWindow(String c2w_url) {
    ...
    System.out.println("Number of open windows is " +
    
    c2w_openWindows.size());
...
c2w_locationY += 20;
if (c2w_locationX + c2w_windowWidth + 10 >

c2w_screenRect.getMaxX()) {

// Window would extend past the right edge of the screen,
// so reset c2w_locationX to its original value.
c2w_locationX = c2w_screenRect.getMinX() + 30;
}
if (c2w_locationY + c2w_windowHeight + 10 >

c2w_screenRect.getMaxY()) {
